...
func TestMakeRequests(t *testing.T) {
	...
	internalRequest03.Imp[0].Ext = []byte(`{"bidder": {"adspaceid": "ad-488663D474E44841E8A293379892348","pubid": "par-7E6D2DB9A8922AB07B44A444D2BA67"}}`)
	internalRequest03.Imp[1].Ext = []byte(`{"bidder": {"adspaceid": "ad-488663D474E44841E8A293379892348","pubid": "par-7E6D2DB9A8922AB07B44A444D2BA67"}}`)
	internalRequest03.Imp[2].Ext = []byte(`{"bidder": {"adspaceid": "ad-488663D474E44841E8A293379892348","pubid": "par-7E6D2DB9A8922AB07B44A444D2BA67"}}`)
	internalRequest03.Imp[3].Ext = []byte(`{"bidder": {"adspaceid": "ad-488663D474E44841E8A293379892348","pubid": "par-7E6D2DB9A8922AB07B44A444D2BA67"}}`)
	internalRequest03.Imp[4].Ext = []byte(`{"bidder": {"adspaceid": "aa","pubid": ""}}`)

	bidder, buildErr := Builder(openrtb_ext.BidderAdmaru, config.Adapter{
